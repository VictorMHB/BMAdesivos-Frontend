...
function FormAdesivo() {
  ...
  useEffect(() => {
    ...
    if (id) {
      adesivoService.getById(id).then((res) => {
  ...
  const validate = () => {
    ...
    if (!formData.tipoAdesivo) newErrors.tipoAdesivo = "Tipo do adesivo é obrigatório.";
    if (!formData.clienteId) newErrors.clienteId = "Cliente é obrigatório.";
    if (!formData.valorUnitario) newErrors.valorUnitario = "Preço de venda é obrigatório.";
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      >
        {/* Dados do Adesivo */}
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-blue mb-4 border-b pb-2">Dados do Adesivo</h2>
        ...
        <div className="flex gap-4 pt-4">
          ...
          >
            {loading ? "Salvando..." : id ? "Salvar Mudanças" : "Cadastrar Adesivo"}
          </button>
          <button
            type="button"
            onClick={() => navigate("/adesivos")}
